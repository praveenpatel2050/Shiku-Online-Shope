...
const Invitation = () => {
  ...
  return (
    ...
    />
        ...
        When you invite a friend to join, he belongs to your team 2-level member, and  you can get his 10% commission income.
        </Typography>
        <Typography variant="h5" sx={{ mt: 1, color: 'orange'}}>
        When a B-level member of your team invites his friend to join, his friend will become a 3-level member of your team, and you can get his 5% commission income.
        And so on Commission will be credited to your account till 10-level.
        </Typography>
      </Container>
      </Box>
    </div>
